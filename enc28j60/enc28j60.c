...
#define ENC28J60_CS_LOW()       ENC28J60_CS_PORT &= ~ENC28J60_CS_PIN
#define ENC28J60_CS_HIGH()      ENC28J60_CS_PORT |= ENC28J60_CS_PIN
#define ENC28J60_RESET_LOW()    ENC28J60_RESET_PORT &= ~ENC28J60_RESET_PIN
#define ENC28J60_RESET_HIGH()   ENC28J60_RESET_PORT |= ENC28J60_RESET_PIN
...
{
  // CS
  ENC28J60_CS_DDR |= ENC28J60_CS_PIN;
  ENC28J60_CS_HIGH();
  // RESET
  ENC28J60_RESET_DDR |= ENC28J60_RESET_PIN;
  ENC28J60_RESET_HIGH();
  // INT
  //ENC28J60_INT_DDR &= ~ENC28J60_INT_PIN;
  // Инициализация SPI
  spim_init();
...
// Процедура сбрасывает логику передатчика
...
{
#ifdef ENC28J60_ERRATA_B7
  // Рекомендация из Errata B.7 - сбросить логику передатчика перед запуском передачи
