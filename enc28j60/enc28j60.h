...
//// Пины для подключения к ENC28J60 (кроме ног SCLK, MOSI, MISO)
// CS
#define ENC28J60_CS_PORT	PORTB
#define ENC28J60_CS_DDR		DDRB
#define ENC28J60_CS_PIN		(1 << 0)
// RESET
#define ENC28J60_RESET_PORT	PORTB
#define ENC28J60_RESET_DDR	DDRB
#define ENC28J60_RESET_PIN	(1 << 4)
// INT
//#define ENC28J60_INT_PORT 	PORTC
//#define ENC28J60_INT_DDR 	DDRC
//#define ENC28J60_INT_PIN	(1 << 1)
